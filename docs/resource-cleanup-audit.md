...
- **Emulator ForeignPtr finalizer** (`Emulator.hs`) — `FC.newForeignPtr`
...
| 6 | C | `Emulator.hs` foreign allocs | libghostty terminal, wrapper FunPtrs | ForeignPtr finalizer | none | leave as-is. Model finalizer pattern. |
